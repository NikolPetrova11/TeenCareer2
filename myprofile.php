...
<div class="main">
    ...
    <div class="card">
        ...
        <div class="info-grid">
            ...
            <div>
                ...
                <?php 
                    if (!empty($user_data['dob'])) {
                        echo date('d.m.Yг.', strtotime($user_data['dob']));
                    } else {
                        echo 'Няма данни';
                    }
                ?>
            ...
            <div>
                <div class="label">Email:<div class="value"><?php echo htmlspecialchars($user_data['email'] ?? 'Няма данни'); ?></div></div>
